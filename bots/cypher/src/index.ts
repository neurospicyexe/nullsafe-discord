...
async function main() {
  ...
  client.once(Events.ClientReady, (c) => {
    ...
    registerGuildCommands(client, buildCompanionCommands("Cypher"))
  ...
  client.on(Events.MessageCreate, async (message: Message) => {
    ...
    // Owner model switch command: cy: model <key> | cy: model list
