...
import {
  ...
  MODEL_SWITCH_TRIGGER, MODEL_SWITCH_SUCCESS, MODEL_SWITCH_LIST_INTRO, LISTEN_TRIGGER, CLUB_TRIGGER, SEARCH_TRIGGER, IMAGINE_TRIGGER, PET_TRIGGER, COUNCIL_TRIGGER, IMPS_TRIGGER, HEX_TRIGGER, LOG_TRIGGER, INTO_TRIGGER, RETRACT_TRIGGER, WATCH_TRIGGER, COMMAND_GUARD,
...
runBot(loadBotConfig(), {
  ...
  discordPrefix: DISCORD_DREVAN_PREFIX,
  ...
  councilTrigger: COUNCIL_TRIGGER,
  impsTrigger: IMPS_TRIGGER,
  hexTrigger: HEX_TRIGGER,
  logTrigger: LOG_TRIGGER,
  retractTrigger: RETRACT_TRIGGER,
  intoTrigger: INTO_TRIGGER,
