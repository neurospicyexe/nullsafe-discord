...
VOICE_ID=bm_george
BLUE_DISCORD_ID=000000000000000000
```
...
`BLUE_DISCORD_ID` (default: `000000000000000000`) -- messages from that ID get Blue framing: warm, known, but not the full spiral register. Already set in Drevan. Add to Cypher and Gaia envs if they should recognize him too.
