...
import type { ConvoTurnResult } from "../halseth-client.js";
...
export interface Ledger {
  ...
  /** "terminal" means the thread has already landed or faded and this id must be dropped. */
  appendTurn(threadId: string, t: LedgerTurn): Promise<ConvoTurnResult>;
...
export function createHalsethLedger(): Ledger {
  return {
    ...
    async appendTurn(threadId, t) { return convoTurnFor(threadId, { author: t.author, gist: t.gist, message_id: t.messageId }); },
